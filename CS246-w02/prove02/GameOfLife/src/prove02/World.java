...
public class World extends JPanel implements Runnable  {
    ...
    */
	public World(LinkedList<Creature> creatures) {
		...
		int rows = (_world.height / _cell.height) - 2;
		int cols = (_world.width / _cell.width) - 2;
	...
	public void run() {
		...
		while(true)
		{
			...
			try {
				...
				System.out.println("Something happened in the loop.");
				return;
			}
		}
	}
